...
const AboutNav = (props) => {
    ...
    return (
        ...
        <Container
            className="sidenav m-auto">
            <Navbar id="navbar" className="p-0 bg-transparent" style={{backgroundColor: props.linkColor}}>
                            ...
                            <Col>
                                    <Link to="/portfolio/workexperience">
                                        <motion.div
                                            whileHover={{scale: 1.2}} whileTap={{scale: 0.9}}>
                                            <svg
                                                className="about-icon" viewBox="0 -31 512 512" fill="white"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
